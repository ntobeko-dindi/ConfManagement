...
public class AttRejectedListAdapter extends ArrayAdapter<SubmitConferenceAttendance> {

    private final Activity activity;
    public AttRejectedListAdapter(Context context, ArrayList<SubmitConferenceAttendance> list, Activity activity){
